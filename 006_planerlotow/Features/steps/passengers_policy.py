...
def step_impl(context):
    context.economy_flight = EconomyFlight("1", 'Warsaw', 'Paris', 10, 10, 10, '2022-12-12')
...
def step_impl(context):
    context.business_flight = BusinessFlight("2", 'Warsaw', 'Paris', 10, 10, 10, '2022-12-12')
...
def step_impl(context):
    context.premium_flight = PremiumFlight("3", 'Warsaw', 'Paris', 10, 10, 10, '2022-12-12')
